...
<p>
  <table width="480px"><tr><td><div align="right"><a href='add_subject.php' class="button" >Add</a></div></td></tr></table>
</p>
<table width="100%" id="rounded-corner" border="0" align="center" cellpadding="0" cellspacing="0" >
<thead>
<tr>
	<th align="center" scope="col" class="rounded-company">Subject Id</th>
...
<?php
        ...
        $result = mysqli_query($conn,"SELECT * FROM subject_master ORDER BY sub_id");
		...
		if(mysqli_num_rows($result)>0)
		{
			 ...
			 {//begin of loop
			   ...
			   echo "<td align=center>"."<a href=\"edit_subject.php?sub_id=$myrow[sub_id]\">edit</a> /"."<a href=\"delete_subject.php?sub_id=$myrow[sub_id]\">delete</a>"."</td>";
			  echo '</tr>';  
