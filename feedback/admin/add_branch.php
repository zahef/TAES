...
if(isset($_POST['submit']))
  {//begin of if($submit).
	...
	else
	{
         ...
         $result = mysqli_query($conn,"INSERT INTO branch_master (b_name) VALUES ('$title')");
...
<tr><td colspan="2" align="center" style="font-size:20px">Add Departnent</td></tr>
  <tr>
    <td width="92">Departnent Name:</td>
    <td width="163"><label>
